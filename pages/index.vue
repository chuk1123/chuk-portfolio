...
export default {
  data() {
    return {
      bio: `
            I am currently a senior at Northwood High School in Irvine, California. I am interested in computer science and code in Python, C++ and Javascript.
